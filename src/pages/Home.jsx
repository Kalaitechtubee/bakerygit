...
//     useEffect(() => {
//         const category = window.location.pathname.split('/')[1]; // Get the category from the URL
//         if (category === '' || category === 'all') {
//             setFilteredProducts(products); // If 'all' or home page, show all products
//         } else {
...
//                 <h1 className="text-3xl font-bold mb-4">Bakery Shop</h1>
